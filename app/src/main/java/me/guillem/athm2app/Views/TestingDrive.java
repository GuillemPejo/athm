...
public class TestingDrive extends AppCompatActivity {
    private static final String TAG = "TestingDrive";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.testing_drive);
    ...
    private void createFile() {
        if (mDriveServiceHelper != null) {
            ...
            ArrayList<String> fileName = (ArrayList<String>) mFileTitleEditText.getText();


            mDriveServiceHelper.createFile(fileName, "Recuperacio de façana");
